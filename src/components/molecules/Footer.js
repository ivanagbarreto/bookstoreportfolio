        ...
        <>
            <footer className="footer">
                ...
                <div className="grupo2">
                    ...
                    <p>
                        Books.com es una librería virtual la cual surgió de la necesidad
                        de encontrar todo en un mismo lugar, ofreciendo un excelente servicio,
                        donde puedes encontrar desde libros, ebooks y audiolibros de diferentes categorías
                        como Best Seller, ficción y clásicos.
                    </p>
                </div>
                    ...
                    <div className="Contacts">
                        ...
                        <div className="red-social">
                            <a target="_blank" href="index.js">
                                <Image src="/instagram-logo.png" alt="Instagram" width={30} height={30} />
                            </a>
                            <a target="_blank" href="index.js">
                                <Image src="/facebook.png" alt="Facebook" width={30} height={30} />
                            </a>
                            <a target="_blank" href="index.js">
                                <Image src="/twitter-logo-.png" alt="Twitter" width={30} height={30} />
                            </a>
                        </div>
                    </div>
